...
class FindDialog:
    ...
    def on_apply(self):
        progress = QProgressDialog('Running find. Please wait...', '', 0, 0)
    ...
    def run_find(self) -> np.ndarray | None:
        results = self.find_func(**self.find_kwargs)
        return results
    ...
    def show_reflections(self, abc_matrix: np.ndarray):
        ...
        dialog.crystal_id = self.crystal_id
